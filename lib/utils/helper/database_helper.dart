...
class DatabaseHelper {
  ...
  /// THIS IS PRIVATE CONSTRUCTOR, I USE IT BECAUSE NO ONE CAN CREATE OBJECT
  ///  FROM THIS CLASS
  /// I AM USING THIS PATTERN FOR SHARING THE SAME INSTANCE IN ALL PROJECT
  /// AND DO NOT CONSUME DEVICE RESOURCES WHEN CREATE NEW INSTANCES
  /// FROM THE SAME CLASS
  DatabaseHelper._();
  ...
  Future<List<Article>> getAllSavedArticles() async {
    ...
    List<Map<String, dynamic>> jsonData =
        await databaseClient!.query(dbTableName);
