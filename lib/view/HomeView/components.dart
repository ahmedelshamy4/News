...
import '../../provider/carousel_slider_provider.dart';
import '../../utils/colors.dart';
import '../../view_model/database_states.dart';
...
AppBar buildHomeViewAppBar(BuildContext context, bool isPortrait) {
  return AppBar(
    ...
    bottom: TabBar(
      onTap: (int index) {
        context.read<TapBarProvider>().changeTapBarIndex(index);
      },
      ...
      tabs: [
        _buildTabItem('top news'.tr()),
        _buildTabItem('business'.tr()),
        _buildTabItem('tech'.tr()),
        _buildTabItem('sports'.tr()),
        _buildTabItem('health'.tr()),
        _buildTabItem('entertainment'.tr()),
      ],
    ),
  );
}
...
class BuildErrorWidget extends StatelessWidget {
  ...
  BuildErrorWidget(
      {Key? key, this.image, this.errorMessage, required this.refresh})
      : super(key: key);
...
class ItemOfList extends StatelessWidget {
  ...
  const ItemOfList({Key? key, required this.article}) : super(key: key);
                        ...
                        builder: (context, provider, child) {
                          return BuildPopupMenuButton(
                            ...
                            onSelect: (value) async {
                              if (value == 'visit') {
                                materialNavigator(
                                    context, WebScreenView(article: article));
                              } else if (value == 'save') {
